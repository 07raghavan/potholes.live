        ...
        <div className="space-y-4">
          <div className="space-y-2 text-center">
            <p className="text-lg font-semibold">
              Mapped <span className="text-destructive font-bold">{potholeCount}</span> pothole{potholeCount === 1 ? '' : 's'} with <span className="font-bold">potholes.live</span>
            </p>
          ...
          <div className="mt-6 text-center">
            <p className="italic text-xs text-muted-foreground leading-relaxed">
              Pro Tip: Take a screenshot of the map showing your detected potholes and share it along with the message above. You can also re-share individual reports from your Profile section anytime. Tag your district administration or local politicians to take action!
            </p>
          </div>
        </div>
      </DialogContent>
